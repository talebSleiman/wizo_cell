            ...
            <div className='container'>
                ...
                <div className='row mt-3 text-md-start text-lg-center'>
                    <div className="col-sm-6 col-md-4 col-lg-4 mb-4">
                        <h4 className="text-uppercase fw-bold">Wizo Cell</h4>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 mb-4">
                        <h4 className="text-uppercase fw-bold">Alfa Products</h4>
                        <hr className="mb-4 mt-0 d-inline-block mx-auto" />
                        <p>
                    ...
                    <div className="col-sm-6 col-md-4 col-lg-4 mb-4">
                        <h4 className="text-uppercase fw-bold">Touch Products</h4>
                        <hr className="mb-4 mt-0 d-inline-block mx-auto" />
                        <p>
